...
public class RotatorTest extends CommandOpMode {
    ...
    public void run(){
        ...
        int rotatorState = (firstDriver.getGamepadButton(GamepadKeys.Button.RIGHT_BUMPER).get() ? 1 : 0) - (firstDriver.getGamepadButton(GamepadKeys.Button.LEFT_BUMPER).get() ? 1 : 0);
